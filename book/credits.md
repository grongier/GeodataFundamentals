...
> `<Title of Chapter or Page>`. In Rongier, G., Rulff, P., Slobbe, C., Verhagen, S. (2026) Geodata Fundamentals Textbook, Delft University of Technology. `<url to specific page on book website>`. Source files at `<link to specific commit / file in github repo`. CC BY 4.0.
...
We thank the whole team behind the [TeachBooks](https://teachbooks.io/) initiative for developing the tools behind this textbook.
